...
<style>
  ...
  .section01 a, .botLink{
    display: inline-block;
    background: url(img/fdo_am_02.jpg) right repeat-y #876b29;
    color: #FFF;
  ...
  .section02 h1{
    ...
    font-size: 5.3em;
    font-family: AspiraBold,Verdana;
    background: url(img/rayatit_am.jpg) bottom center no-repeat;
    padding-bottom: 15px;
    padding-top: 30px;
  }
  ...
  .section13 header{
    background: url(img/fdo_partner.jpg) left repeat-y #f9d587;
    text-align: center;
    padding: 20px 0;
  }
  .section13 header h1{
  ...
  .section14 img{
    ...
    <div class="content">
      ...
      <section class="section02">
        <header>
          <h1><img src="img/star_am.jpg" /> Crown Sponsors <img src="img/star_am.jpg" /></h1>
        </header>
        <div class="gale">
          <? for($i=1;$i<=9;$i++){?>
          <a href="#"><img src="img/promociona.jpg" /></a>
          <? } ?>
        </div>
      </section>
